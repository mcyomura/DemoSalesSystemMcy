...
* The swaggers (only BFF will be externally exposed, but I provide internal swaggers as well): [bff](Documentation/swagger_bff.json), [order](Documentation/swagger_order-service.json), [catalog](Documentation/swagger_catalog-service.json)
